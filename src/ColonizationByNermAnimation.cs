...
{
    /// <summary>
    ///   A Nerfed version of UsiAnimation (from the USITools add-on).  Nerfed in that it
    ///   does not consume any resources to deploy.
    /// </summary>
    public class ColonizationByNermAnimation : PartModule, IMultipleDragCube
    {
